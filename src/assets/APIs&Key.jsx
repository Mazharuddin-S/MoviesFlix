export const ImageAPI = "https://image.tmdb.org/t/p/w154"; // + image path

export const api_key = "2dca580c2a14b55200e784d157207b4d";
export const HomePageAPI =
  "https://api.themoviedb.org/3/discover/movie?api_key=2dca580c2a14b55200e784d157207b4d&sort_by=popularity.desc&page=1&vote_count.gte=100"; // + &primary_release_year=2023

export const genresAPI =
  "https://api.themoviedb.org/3/discover/movie?api_key=2dca580c2a14b55200e784d157207b4d"; // + &with_genres=12&without_genres=28,18;

export const searchAPI =
  "https://api.themoviedb.org/3/search/movie?api_key=2dca580c2a14b55200e784d157207b4d"; // + &query=avengers&include_adult=false&language=en-US&page=1 ;

export const youtubeLink = "https://www.youtube.com/embed/"; // + videokey

export const searchById = "https://api.themoviedb.org/3/movie/"; // 157336?api_key=API_KEY&append_to_response=videos
const genres = {
  genres: [
    { id: 28, name: "Action" },
